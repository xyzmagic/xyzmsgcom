...
```html
<!-- Trigger -->
<button class="btn" data-clipboard-text="Just because you can doesn't mean you should 鈥� clipboard.js">
    Copy to clipboard
</button>
```
...
[MIT License](http://zenorocha.mit-license.org/) 漏 Zeno Rocha
