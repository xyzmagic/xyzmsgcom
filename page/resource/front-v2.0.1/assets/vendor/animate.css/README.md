...
Animate.css is powered by [gulp.js](http://gulpjs.com/), and you can create custom builds pretty easily. First of all, you鈥檒l need Gulp and all other dependencies:
...
Next, run `gulp` to compile your custom builds. For example, if you want only some of the 鈥渁ttention seekers鈥�, simply edit the `animate-config.json` file to select only the animations you want to use.
