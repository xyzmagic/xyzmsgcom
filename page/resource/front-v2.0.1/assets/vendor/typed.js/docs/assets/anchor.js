...
function AnchorJS(options) {
  ...
  this._applyRemainingDefaultOptions = function(opts) {
    this.options.icon = this.options.hasOwnProperty('icon') ? opts.icon : '\ue9cb'; // Accepts characters (and also URLs?), like  '#', '露', '鉂�', or '搂'.
  ...
  this.add = function(selector) {
    ...
    for (i = 0; i < elements.length; i++) {
      ...
      if (elements[i].hasAttribute('id')) {
        ...
        //
        // Example string:                                // '鈿♀殹鈿� Unicode icons are cool--but they definitely don't belong in a URL fragment.'
