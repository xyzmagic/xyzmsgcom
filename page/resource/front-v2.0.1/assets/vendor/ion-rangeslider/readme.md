...
> English description | <a href="readme.ru.md">袨锌懈褋邪薪懈械 薪邪 褉褍褋褋泻芯屑</a>
...
## Description
* Ion.RangeSlider 鈥� cool, comfortable, responsive and easily customizable range slider
...
* Additional postfix for maximum value (eg. $0 鈥� $100<b>+</b>)
...
| `max_postfix` | `data-max-postfix` | `` | string | Special postfix, used only for maximum value. Will be showed after handle will reach maximum right position. For example **0 鈥� 100+** |
| `decorate_both` | `data-decorate-both` | `true` | boolean | Used for **double** type and only if prefix or postfix was set up. Determine how to decorate close values. For example: **$10k 鈥� $100k** or **$10 鈥� 100k** |
| `values_separator` | `data-decorate-both` | ` - ` | string | Set your own separator for close values. Used for **double** type. Default: **10 鈥� 100**. Or you may set: **10 to 100, 10 + 100, 10 &rarr; 100** etc. |
...
| `extra_classes` | `data-extra-classes` | `鈥擿 | string | Traverse extra CSS-classes to sliders container |
