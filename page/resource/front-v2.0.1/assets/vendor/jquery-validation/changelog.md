...
## Localization
  ...
  * Adding Per煤 Spanish (ES PE)
  * Adding Georgian (醿メ儛醿犪儣醿ａ儦醿�, ge)
...
* Added ipv4 and ipv6 to additional methods, thanks Natal Ng茅tal
...
* Added feature: Add errorClass to invalid field锟絪 parent element, making it easy to style the label/field container or the label for the field.
...
* Improved dependency feature by adding two custom expressions: ":blank" to select elements with an empty value and 锟�:filled锟� to select elements with a value, both excluding whitespace
...
* Modified validation methods to accept empty fields as valid (exception: of course 锟絩equired锟� and also 锟絜qualTo锟� methods)
