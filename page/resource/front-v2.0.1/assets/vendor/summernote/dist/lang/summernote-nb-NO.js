  ...
  $.extend($.summernote.lang, {
    'nb-NO': {
      font: {
        ...
        size: 'Skriftst酶rrelse'
      },
      image: {
        image: 'Bilde',
        insert: 'Sett inn bilde',
        resizeFull: 'Sett full st酶rrelse',
        resizeHalf: 'Sett halv st酶rrelse',
        resizeQuarter: 'Sett kvart st酶rrelse',
        floatLeft: 'Flyt til venstre',
        floatRight: 'Flyt til h酶yre',
      ...
      link: {
        ...
        openInNewWindow: '脜pne i nytt vindu'
      },
      table: {
        table: 'Tabell',
