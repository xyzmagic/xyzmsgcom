  ...
  $.extend($.summernote.lang, {
    'ca-ES': {
      font: {
        ...
        height: 'Al莽ada de l铆nia',
        name: 'Font',
        strikethrough: 'Ratllat',
        subscript: 'Sub铆ndex',
        superscript: 'Super铆ndex',
        size: 'Mida de lletra'
      },
      image: {
        image: 'Imatge',
        ...
        shapeNone: 'Forma: Cap',
        dragImageHere: 'Arrossegueu una imatge o text aqu铆',
        dropImage: 'Deixa anar aqu铆 una imatge o un text',
        selectFromFiles: 'Seleccioneu des dels arxius',
        maximumFileSize: 'Mida m脿xima de l\'arxiu',
        maximumFileSizeError: 'La mida m脿xima de l\'arxiu s\'ha superat.',
      ...
      video: {
        video: 'V铆deo',
        videoLink: 'Enlla莽 del v铆deo',
        insert: 'Inserir v铆deo',
        url: 'URL del v铆deo?',
        providers: '(YouTube, Vimeo, Vine, Instagram, DailyMotion o Youku)'
      },
      link: {
        link: 'Enlla莽',
        insert: 'Inserir enlla莽',
        unlink: 'Treure enlla莽',
        edit: 'Editar',
        textToDisplay: 'Text per mostrar',
        url: 'Cap a quina URL porta l\'enlla莽?',
      ...
      hr: {
        insert: 'Inserir l铆nia horitzontal'
      },
      style: {
        style: 'Estil',
        p: 'p',
      ...
      lists: {
        unordered: 'Llista desendre莽ada',
        ordered: 'Llista endre莽ada'
      },
      options: {
        help: 'Ajut',
      ...
      paragraph: {
        paragraph: 'Par脿graf',
        outdent: 'Menys tabulaci贸',
        indent: 'M茅s tabulaci贸',
      ...
      shortcut: {
        ...
        action: 'Acci贸',
        paragraphFormatting: 'Format de par脿graf',
        documentStyle: 'Estil del document',
        extraKeys: 'Tecles adicionals'
      },
      help: {
        'insertParagraph': 'Inserir par脿graf',
        'undo': 'Desfer l\'煤ltima acci贸',
        'redo': 'Refer l\'煤ltima acci贸',
        'tab': 'Tabular',
        'untab': 'Eliminar tabulaci贸',
        ...
        'insertUnorderedList': 'Inserir llista desendre莽ada',
        'insertOrderedList': 'Inserir llista endre莽ada',
        'outdent': 'Redu茂r tabulaci贸 del par脿graf',
        'indent': 'Augmentar tabulaci贸 del par脿graf',
        'formatPara': 'Canviar l\'estil del bloc com a un par脿graf (etiqueta P)',
        ...
        'insertHorizontalRule': 'Inserir una l铆nia horitzontal',
        'linkDialog.show': 'Mostrar panel d\'enlla莽os'
      },
      history: {
        undo: 'Desfer',
        redo: 'Refer'
      ...
      specialChar: {
        specialChar: 'CAR脌CTERS ESPECIALS',
        select: 'Selecciona car脿cters especials'
      }
    }
  });
})(jQuery);
