  ...
  $.extend($.summernote.lang, {
    'fi-FI': {
      ...
      image: {
        ...
        resizeQuarter: 'Nelj盲sosa leveys',
      ...
      link: {
        ...
        edit: 'Muokkaa',
        textToDisplay: 'N盲ytett盲v盲 teksti',
      ...
      options: {
        ...
        codeview: 'HTML-n盲kym盲'
      },
      paragraph: {
        paragraph: 'Kappale',
        outdent: 'Pienenn盲 sisennyst盲',
        indent: 'Suurenna sisennyst盲',
      ...
      color: {
        recent: 'Viimeisin v盲ri',
        more: 'Lis盲盲 v盲rej盲',
        background: 'Taustav盲ri',
        foreground: 'Tekstin v盲ri',
        transparent: 'L盲pin盲kyv盲',
        setTransparent: 'Aseta l盲pin盲kyv盲ksi',
        reset: 'Palauta',
        resetToDefault: 'Palauta oletusarvoksi'
      },
      shortcut: {
        shortcuts: 'Pikan盲pp盲imet',
        close: 'Sulje',
